...
final layOutQuestionsList = [
  LayOutQuestion(
    ...
    correctAnswer: const LayOutOption(
        text:
            "El patrimonio neto es la diferencia entre lo que una entidad posee (activos) y lo que debe (pasivos), representando su valor financiero.",
        isCorrect: true),
  ),
  LayOutQuestion(
    text: "\t¿Cuál de las siguientes opciones es un pasivo?",
    options: [
    ...
    correctAnswer: const LayOutOption(
        text:
            "Un préstamo bancario es un pasivo, ya que representa una obligación financiera que una entidad tiene con una institución financiera y debe ser devuelta en el futuro.",
        isCorrect: true),
  ),

  LayOutQuestion(
    text: "¿Qué es el presupuesto?",
    options: [
    ...
    correctAnswer: const LayOutOption(
        text:
            "El presupuesto es un plan financiero que estima los ingresos y gastos futuros durante un período específico.",
        isCorrect: true),
  ),
  ...
  LayOutQuestion(
    ...
    correctAnswer: const LayOutOption(
        text:
            "Una forma de ingreso variable es aquella que fluctúa según ciertos factores, como el desempeño de un negocio, las ventas de productos o servicios, o las comisiones por ventas.",
        isCorrect: true),
  ),
  // other 4
  LayOutQuestion(
    text: "\t¿Qué es el valor temporal del dinero?",
    options: [
    ...
    correctAnswer: const LayOutOption(
        text:
            "El valor temporal del dinero es la idea de que un dólar hoy vale más que un dólar en el futuro debido a su potencial para generar ganancias adicionales a lo largo del tiempo.",
        isCorrect: true),
  ),
];
